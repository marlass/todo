...
test('get tasks by deadline', function(t){
     request(app)
...
test('get tasks by project', function(t){
     request(app)
    .get('/tasks/?sort=project')    
    .set('x-access-token', token)
    .expect(200)
    .end(function(err, result){      
        t.error(err, 'No errors');
...
test('get tasks by real size', function(t){
     request(app)
    .get('/tasks/?sort=real-size')    
    .set('x-access-token', token)
    .expect(200)
    .end(function(err, result){      
        t.error(err, 'No errors');
